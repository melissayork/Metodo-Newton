...
def cauchy(f, x0, epsilon1, epsilon2, M):
    terminar=False
    xk=x0
    k=0
    ...
    while not terminar:
        ...
        if np.linalg.norm(grad)<epsilon1 or k>=M:
            ...
            alpha=busquedaDorada(alpha_funcion, epsilon=epsilon2, a=0.0, b=1.0) #aqui cambiar
            x_k1=xk-alpha*grad
...
print(cauchy(himmenblau, x0, e1, e2, max_iter))